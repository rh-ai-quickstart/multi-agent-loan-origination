...
add_if_set secrets.AGENT_NAME AGENT_NAME
add_if_set secrets.MCP_RISK_SERVER_URL MCP_RISK_SERVER_URL
add_if_set secrets.PREDICTIVE_MODEL_MCP_URL PREDICTIVE_MODEL_MCP_URL
